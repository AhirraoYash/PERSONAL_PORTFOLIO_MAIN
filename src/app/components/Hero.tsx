...
const Hero = () => {
  const socialLinks = [
    ...
    {
      icon: Linkedin,
      href: "https://www.linkedin.com/in/yash-ahirrao-57508b253/",
      label: "LinkedIn",
    },
    { icon: Github, href: "https://github.com/ahirraoYash", label: "GitHub" },
    {
      icon: Instagram,
      href: "https://www.instagram.com/yash_ahirrao_/ q",
      label: "Instagram",
    },
    { icon: Mail, href: "mailto:yashahirrao204@gmail.com", label: "Email" },
  ];
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground">
                  I&apos;m <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Yash Ahirrao</span>
                  <br />
